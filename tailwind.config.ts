	...
	theme: {
		...
		extend: {
			...
			colors: {
				...
				/* Game Menu Color System */
				'neon-blue': 'hsl(var(--neon-blue))',
				'neon-blue-glow': 'hsl(var(--neon-blue-glow))',
				'neon-blue-dark': 'hsl(var(--neon-blue-dark))',
				'neon-blue-subtle': 'hsl(var(--neon-blue-subtle))',
				...
				'timeline-connector': 'hsl(var(--timeline-connector))',
				'skill-badge': 'hsl(var(--skill-badge))',
				'particle-glow': 'hsl(var(--particle-glow))',
